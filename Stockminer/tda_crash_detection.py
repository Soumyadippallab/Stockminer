...
def process_stock_data(file_path=None, dimension=3, delay=1, window_size=50, homology_dims=[0, 1], bottleneck_threshold=0.01, other_threshold=0.05, price_drop_threshold=-7):
